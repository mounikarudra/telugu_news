...
import com.example.mouni.news_tabview.DeveloperKey;
...
public class Youtube_Adapter extends RecyclerView.Adapter<Youtube_Adapter.VideoInfoHolder> {
    ...
    public Youtube_Adapter(Context context) {
        this.ctx = context;
    }

    @Override
    public VideoInfoHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.youtubeitem_list, parent, false);
